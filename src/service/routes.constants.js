...
export const AUTH_ROUTES = {
  ...
  LOGIN: "/planner/login",
  UPDATE_IMAGE: (plannerId) => `/planner/update/${plannerId}?image`,
  GET_LOGGED_IN_PLANNER: "/planner/me",
  UPDATE_PASSWORD: "/planner/change-password",
  UPDATE_PROFILE: (plannerId) => `/planner/update/${plannerId}`,

 
  // //INVOICE
  // GET_CLIENT_INVOICE: "/invoice/",
  // CREATE_CLIENT_INVOICE: "/invoice/"
